...
from settings import DEVICE, NUM_IMAGES, screwed_transform
from utils import create_grid


def validate(net: nn.Module, epoch: int, criterion: nn.Module, validation_loader: DataLoader,
             sw: SummaryWriter) -> float:
    net.eval()
